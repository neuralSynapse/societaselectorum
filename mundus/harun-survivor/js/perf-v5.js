...
const gameScale=.68,fxScale=.44,worldScale=.72;rescale('#game',gameScale);rescale('#v4fx',fxScale);const c=document.querySelector('#v5WorldFx'),ctx=rescale('#v5WorldFx',worldScale);if(!c||!ctx)return;
...
window.HarunV5Perf=Object.freeze({version:'5.0.3-v6',gameScale,fxScale,worldScale,lowFx:()=>lowFx,lastFps:()=>acc,dense});requestAnimationFrame(monitor);
})();