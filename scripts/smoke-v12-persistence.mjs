...
if(typeof second.window.__H93_GET_STATE!=='function'||typeof second.window.__H93_SAVE_STATE!=='function'||typeof second.window.__H93_RENDER!=='function')throw new Error('Persistência: bridge real do V12 não foi exposto');
